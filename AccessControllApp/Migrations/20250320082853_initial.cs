        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CccdId = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessLogs_AccessRequestId",
                table: "AccessLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessRequests_UserApprovalid",
                table: "AccessRequests",
                column: "UserApprovalid");

            migrationBuilder.CreateIndex(
                name: "IX_AccessRequests_UserRequestId",
                table: "AccessRequests",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AccessLogs_AccessRequests_AccessRequestId",
                table: "AccessLogs",
                column: "AccessRequestId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AccessRequests_Users_UserApprovalid",
                table: "AccessRequests",
                column: "UserApprovalid",
                principalTable: "Users",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AccessRequests_Users_UserRequestId",
                table: "AccessRequests",
                column: "UserRequestId",
                principalTable: "Users",
                principalColumn: "Id");
